...
search.addEventListener("click", function() {
    ...
    fetch(`http://api.weatherapi.com/v1/forecast.json?key=a723218da53a464d8cf182437232609&q=${userLocation}&days=4`)
        ...
        document.querySelector("#chance-of-precipitation").textContent = "Chance of Precipitation: " + today.chanceOfPrecipitation + "%";
        ...
        if (today.currentTemp > 80) {
            return temperatureTypeDiv.textContent = "It's Hot Today!"
        } else if (today.currentTemp < 40) {
            return temperatureTypeDiv.textContent = "It's Cold Today!"
        } else if (today.currentTemp > 100) {
            return temperatureTypeDiv.textContent = "Excessive Heat Warning";
        } else {
            return temperatureTypeDiv.textContent = "The Weather is Average!"
        };
